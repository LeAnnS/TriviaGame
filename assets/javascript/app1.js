...
$("#start").on("click", function() {
	...
	$("#wrapper").append("<h2"> +questions[i].triviaQuestion+ </h2>");
	// for (var i=0; i<questions.length; i++) {
		// $("#subwrapper").append("<h2>Hello</h2>");
	// }
})
...
var question1 = new Question(questions[0], 38, 23, 10, 30)
	...
	console.log (question1.correct | question1.wrong1 | question1.wrong2 | question1.wrong3)
